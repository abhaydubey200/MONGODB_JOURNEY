...
const createRandomStudent = () => {
    ...
    return { name: randomName, mon: randomMon, fees: randomFees, email: randomEmail };
}
...
const createStudents = async () => {
    try {
       ...
       1=>$elemMatch...
        ...
        // Query students where the length of the name is equal to 4
        const studentsWithFourCharacterNames = await Product.find({ $expr: { $eq: [{ $strLenCP: "$name" }, 1] } });
